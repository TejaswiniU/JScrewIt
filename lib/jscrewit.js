...
(function () {
    ...
    var Solution = /** @class */ (function () {
        ...
        Object.defineProperty(Solution.prototype, "length", {
            get: function () {
        ...
        Solution.prototype.charAt = function (index) {
    ...
    (function () {
        ...
        isMaskCompatible =
            function (mask) {
                return incompatibleMaskList.every(function (incompatibleMask) { return !maskIncludes(mask, incompatibleMask); });
            };
        ...
        var incompatibleMaskList = _Object_keys(incompatibleMaskMap).map(function (key) { return incompatibleMaskMap[key]; });
        ELEMENTARY.sort(function (feature1, feature2) {
            return feature1.name < feature2.name ? -1 : 1;
        });
        _Object_freeze(ELEMENTARY);
        var autoFeatureObj = createFeature('AUTO', 'All features available in the current engine.', autoMask);
