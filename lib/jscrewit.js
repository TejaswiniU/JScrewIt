...
(function () {
    ...
    var FEATURE_INFOS = {
        ...
        ANY_WINDOW: {
            description: 'Existence of the global object self whose string representation starts with ' +
        ...
        ARRAY_ITERATOR: {
            description: 'The property that the string representation of Array.prototype.entries() starts ' +
        ...
        ESC_HTML_ALL: {
            description: 'The property that double quotation mark, less than and greater than characters in ' +
        ...
        ESC_HTML_QUOT: {
            description: 'The property that double quotation marks in the argument of ' +
                'String.prototype.fontcolor are escaped as "&quot;".',
            check: function () { return ~''.fontcolor('"').indexOf('&quot;'); },
        },
        ESC_HTML_QUOT_ONLY: {
            description: 'The property that only double quotation marks and no other characters in the ' +
        ...
        FUNCTION_19_LF: {
            description: 'A string representation of dynamically generated functions where the character at ' +
        ...
        HTMLAUDIOELEMENT: {
            description: 'Existence of the global object Audio whose string representation starts with ' +
        ...
        INCR_CHAR: {
            description: 'The ability to use unary increment operators with string characters, like in ( ' +
        ...
        NO_IE_SRC: {
            description: 'A string representation of native functions typical for most engines with the ' +
        ...
        NO_OLD_SAFARI_ARRAY_ITERATOR: {
            description: 'The property that the string representation of Array.prototype.entries() evaluates ' +
        ...
        NO_V8_SRC: {
            description: 'A string representation of native functions typical for Firefox, Internet Explorer ' +
                'and Safari.\n' +
        ...
        UNDEFINED: {
            description: 'The property that Object.prototype.toString.call() evaluates to "[object ' +
                'Undefined]".\n' +
            ...
            check: function () {
                ...
                var available = toString.call() === '[object Undefined]';
                return available;
            },
        },
        UNEVAL: {
        ...
        V8_SRC: {
            description: 'A string representation of native functions typical for the V8 engine, but also ' +
                'found in Edge.\n' +
                'Remarkable traits are the lack of line feed characters at the beginning and at the ' +
